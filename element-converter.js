...
const { transformJSX } = require('./index');

const programCLI = new Command();
programCLI
    .version('1.0.0')
    .description('Convert only JSX elements from ReactJS to Expo components')
...
console.log(`JSX elements conversion complete! Output written to ${outputPath}`);
