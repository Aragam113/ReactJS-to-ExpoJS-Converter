...
const {
    ...
    addTypeInterfaces,
    addFontLoading,
    collectUsedReactNativeComponents,
    ensureReactNativeImports
} = require('./index');

const programCLI = new Command();
programCLI
    .version('1.0.0')
    .description('Finalize the conversion by adding SecureStore, fonts, TS interfaces, etc.')
...
console.log(`Final conversion steps complete! Output written to ${outputPath}`);
